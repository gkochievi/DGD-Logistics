...
urlpatterns = [
    ...
    path('profile/contracts/', views.CustomerContractsView.as_view(), name='customer_contracts'),
    ...
    path('admin/users/<int:pk>/contracts/', views.AdminUserContractsView.as_view(), name='admin_user_contracts'),
    path('admin/users/<int:pk>/contracts/<int:contract_id>/', views.AdminUserContractDetailView.as_view(), name='admin_user_contract_detail'),
